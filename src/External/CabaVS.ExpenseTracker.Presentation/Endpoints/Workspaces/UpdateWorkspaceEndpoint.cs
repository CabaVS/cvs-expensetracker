...
internal sealed class UpdateWorkspaceEndpoint(
    ISender sender) : Endpoint<UpdateWorkspaceEndpoint.RequestModel, Results<Ok, BadRequest<Error>>>
{
    ...
    public sealed record RequestModel(Guid WorkspaceId, string Name);
}
